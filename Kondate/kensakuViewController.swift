...
class kensakuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, TabBarDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.likeFunc = { i in
            ...
            case 0:
                fetchData[0].asalike = Int32(i)
            case 1:
                fetchData[0].hirulike = Int32(i)
            case 2:
                fetchData[0].yorulike = Int32(i)
            default:
                break
            }
            do {
    ...
    func reloadData() {
        ...
        for data in fetchData {
            ...
            likenumberArray.append(Int(data.asalike))
            
            likenumberArray.append(Int(data.hirulike))
            
            likenumberArray.append(Int(data.yorulike))
        }
